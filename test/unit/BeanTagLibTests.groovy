...
class BeanTagLibTests extends GrailsUnitTestCase {
    ...
    void testBeanAndPropertyResolution() {
        ...
        def result = taglib.getActualBeanAndProperty(bean, "items")
        ...
        result = taglib.getActualBeanAndProperty(bean, "items[1]")
        assertTrue bean.is(result.bean)
        assertEquals 'items', result.propertyName
        ...
        result = taglib.getActualBeanAndProperty(bean, "items.description")
        ...
        result = taglib.getActualBeanAndProperty(bean, "items[1].description")
        ...
        result = taglib.getActualBeanAndProperty(bean, "items.descriptions[0].value")
